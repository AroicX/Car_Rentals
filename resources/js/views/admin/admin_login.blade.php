...
<head>
    ...
    <title>VETOMART - Admin Login</title>
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-dark">
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    ...
                    <!-- Form -->
                    <form class="form-horizontal m-t-20" id="loginform" role="form" method="POST" action="{{ url('admin') }}">
                        {{ csrf_field() }}
                        <div class="row p-b-30">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="email" name="email" class="form-control form-control-lg" placeholder="Email Address" aria-label="Email Address" aria-describedby="basic-addon1" required="">
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                    ...
                    <div class="row m-t-20">
                        ...
                        <form class="col-12" action="index.html">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="email" name="re_email" class="form-control form-control-lg" placeholder="Email Address" aria-label="Email Address" aria-describedby="basic-addon1">
                            </div>
                            <!-- pwd -->
