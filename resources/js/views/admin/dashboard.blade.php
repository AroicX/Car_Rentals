                ...
                <div class="card-body">
                    ...
                    <div class="chat-box scrollable" style="height:475px;">
                        ...
                        <ul class="chat-list">
                            <!--chat Row -->
                            <li class="chat-item">
                                <div class="chat-img"><img src="{{ asset('images/backend_images/users/1.jpg') }}" alt="user"></div>
                            ...
                            <!--chat Row -->
                            <li class="chat-item">
                                <div class="chat-img"><img src="{{ asset('images/backend_images/users/2.jpg') }}" alt="user"></div>
                                <div class="chat-content">
                ...
                <div class="tab-content tabcontent-border">
                    <div class="tab-pane active" id="home" role="tabpanel">
                        <div class="p-20">
                            ...
                            <img src="{{ asset('images/backend_images/background/img4.jpg') }}" class="img-fluid">
                        </div>
                    </div>
