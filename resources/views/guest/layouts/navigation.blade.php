        ...
        <div class="x_top_header_right_side_wrapper float_left">
            ...
            <div class="x_top_header_all_select_box_wrapper">
                <ul>
                    ...
                    <li class="login"> <a href="/login"><i class="fa fa-power-off"></i> &nbsp;&nbsp;login</a>
                    </li>
                    <li class="register"> <a href="/register"><i class="fa fa-plus-circle"></i>
                            &nbsp;&nbsp;register</a>
                    </li>
        ...
        <div class="row">
            <div class=" col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                <div class="hs_logo_wrapper d-none d-sm-none d-xs-none d-md-block">
                    <a href="/">
                        <img src="{{asset('images/logo.png')}}" class="img-responsive" alt="logo" title="Logo" />
                    </a>
                </div>
            </div>
                ...
                <nav class="hs_main_menu d-none d-sm-none d-xs-none d-md-block">
                    <ul>
                        <li>
                            ...
                            <a class="menu-button single_menu" href="/">Home</a>

                        </li>
                        <li>
                            <a class="menu-button single_menu" href="/cars">Cars</a>
                        </li>
                        <li> <a class="menu-button single_menu" href="/about">About</a>
                        </li>

                        <li> <a class="menu-button single_menu" href="/services">services </a>
                        </li>

                        <li> <a class="menu-button single_menu" href="/contact">Contact </a>
                        </li>
                    </ul>
                </nav>
